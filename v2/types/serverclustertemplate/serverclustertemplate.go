...
func (c *Client) Add(serverClusterTemplate *ServerClusterTemplateW) (reply http.HTTPReply, err error) {
...
func (c *Client) Update(id int, serverClusterTemplate *ServerClusterTemplateW) (reply http.HTTPReply, err error) {
	js, err := json.Marshal(serverClusterTemplate)
	if err != nil {
